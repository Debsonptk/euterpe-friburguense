...
import { ImageSize, TextColor } from './styles'
    ...
    <>
      ...
      <Container>
        ...
        <p className="fs-5">
          ...
          professores, estudantes, empresários etc. Pessoas com as mais diversas
          profissões, que carregam em si o amor pela música e pela nossa querida
