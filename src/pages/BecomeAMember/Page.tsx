...
import { ContentBecomeAMember } from './styles'
            ...
            <Row className="row-cols-1 row-cols-md-2">
              <Col className="pb-5">
                ...
                <p>
                  ...
                  Friburgo, sendo convertido em pagamento de contas internas,
                  tais como: salário de professores e funcionários. Entretanto,
                  tal auxílio não é suficiente para a manutenção completa de sua
                  Sede (reformada em Julho de 2019 através da contribuição dos
                  sócios), de sua Banda de Música e de sua Escola de Música.
                  Para tanto, precisamos da contribuição mensal de nossos sócios
                  mantenedores, que são de suma importância para o crescimento
                  da Euterpe Friburguense.
                </p>
                <p>
